...
const PokemonDetails = () => {
  ...
  const { data: PokemonResult, isError, isLoading } = usePokemonFetch(name);
              ...
              <div className="lg:grid lg:grid-cols-2 ">
                <div className="p-3 m-auto">
                  ...
                  <img
                    ...
                    alt="pokemonPicture"
                    className="md:size-[30rem] m-auto"
                  />
                </div>
                <div className="space-y-6 md:w-[40rem] m-auto">
                    ...
                    <span className="flex gap-2 text-center">
                      {PokemonResult?.types.map((t: types, index: number) => (
                        <div
                          ...
                          style={{
                            backgroundColor: backgroundColors[t.type.name],
                          }}
                        >
                          <h4>{t.type.name}</h4>
